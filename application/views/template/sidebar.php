                                ...
                                <div id="collapseOne" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td>
                                                    <i class="fa fa-users"><a href="<?php echo site_url('anggota');?>"></i> Anggota</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
													<span class="glyphicon glyphicon-user  text-primary"></span><a href="<?php echo site_url('dashboard/petugas');?>">Petugas</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span class="glyphicon glyphicon-list-alt text-primary"></span> <a href="<?php echo site_url('profile');?>">Profile</a>
                                                </td>
                                            </tr>
